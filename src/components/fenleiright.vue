...
<template>
    <div class="mmm">
      <div class="box-m" id="meishi">  
        <div class="right-1">
          <span class="right-4">美食</span>
        ...
        <div class="right-2">
          ...
          <li>
           ...
           <li>
            ...
            <li>
            <div class="right-3">
              <img src="../assets/fenlei5.png" alt="">
            </div>
            <div class="box3">
              <p class="box1">包子粥铺</p>
          ...
          <li>
            <div class="right-3">
              <img src="../assets/fenlei6.png" alt="">
            </div>
            <div class="box3">
              <p class="box1">意面披萨</p>
            ...
            <li>
            <div class="right-3">
              <img src="../assets/fenlei7.png" alt="">
            </div>
            <div class="box3">
              <p class="box1">川湘菜</p>
              <p><span class="box6">80</span></p>
            </div>
          </li>
